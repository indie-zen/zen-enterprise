...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_I_TIMEOUT_HANDLER_HPP_INCLUDED
#define ZEN_ENTERPRISE_I_TIMEOUT_HANDLER_HPP_INCLUDED
...
#endif // ZEN_ENTERPRISE_I_TIMEOUT_HANDLER_HPP_INCLUDED
