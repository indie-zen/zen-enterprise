...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_I_NETWORK_SERVICE_HPP_INCLUDED
#define ZEN_ENTERPRISE_I_NETWORK_SERVICE_HPP_INCLUDED
...
#endif // ZEN_ENTERPRISE_I_NETWORK_SERVICE_HPP_INCLUDED
